        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            ...
            [2] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 43, Text = "или попросите Коннери первым продемонстрировать свои атлетические навыки" },
                }
            },
            [3] = new Paragraph
            {
            ...
            [5] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 75, Text = "Или проигнорируете" },
                }
            },
            [6] = new Paragraph
            {
            ...
            [8] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 34, Text = "Итак, вы будете пересекать рой, прикрывшись одеялом" },
                    new Option { Destination = 17, Text = "или предпочтете непокрытую голову и хорошую видимость" },
                }
            },
            [9] = new Paragraph
            {
            ...
            [10] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 30, Text = "или доесть в тишине" },
                }
            },
            [11] = new Paragraph
            {
            ...
            [12] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 92, Text = "или послушаетесь" },
                }
            },
            [13] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 104, Text = "или метнуться к Коннери" },
                }
            },
            [14] = new Paragraph
            {
            ...
            [16] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 11, Text = "или нет" },
                }
            },
            [17] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 65, Text = "или прорываться без помощи магии" },
                }
            },
            [18] = new Paragraph
            {
            ...
            [34] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 58, Text = "или нет" },
                }
            },
            [35] = new Paragraph
            {
            ...
            [40] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 28, Text = "Нет горшочка и не надо" },
                }
            },
            [41] = new Paragraph
            {
            ...
            [52] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 70, Text = "Напарника нет, его вещей тоже! Вы подскочите как угорелый и броситесь на поиски" },
                    new Option { Destination = 32, Text = "либо не спеша соберетесь и лишь потом начнете розыск" },
                }
            },
            [53] = new Paragraph
            {
            ...
            [58] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 110, Text = "Теперь либо продолжать двигаться вперед, надеясь, что ничего страшного с ним не случится" },
                    new Option { Destination = 85, Text = "либо сбросить одеяло и спасать напарника (тогда сразу вычеркните одеяло из своих вещей, оно останется на дороге)" },
                }
            },
            [59] = new Paragraph
            {
            ...
            [63] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 21, Text = "Бросьте кубик (если выпало 6 идите на" },
                    new Option { Destination = 49, Text = "Вы дадите ему это сделать" },
                    new Option { Destination = 119, Text = "– А я давненько не шинковал в капусту уродливых демонов" },
                    new Option { Destination = 89, Text = "– Следуй за белым кроликом, птица" },
                }
            },
            [64] = new Paragraph
            {
            ...
            [73] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 22, Text = "Итак, вы согласитесь заплатить" },
                    new Option { Destination = 48, Text = "или откажетесь и уйдете" },
                }
            },
            [74] = new Paragraph
            {
            ...
            [77] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 92, Text = "или согласитесь, что продолжить путь – это лучшее решение" },
                }
            },
            [78] = new Paragraph
            {
            ...
            [81] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 102, Text = "Или треснете гардой меча по затылку с теми же целями" },
                }
            },
            [82] = new Paragraph
            {
            ...
            [88] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 66, Text = "Теперь сделайте выбор – вы можете еще посидеть с попутчиками за столом" },
                    new Option { Destination = 35, Text = "или же подняться в комнату" },
                }
            },
            [89] = new Paragraph
            {
            ...
            [92] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 63, Text = "Ваш выбор: направо" },
                    new Option { Destination = 8, Text = "или налево" },
                }
            },
            [93] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 4, Text = "Если у вас записано слово крик, идите на" },
                }
            },
            [94] = new Paragraph
            {
            ...
            [95] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 56, Text = "Если у вас записано слововремя,то–" },
                }
            },
            [96] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 77, Text = "Вы скажете напарнику «Я сверну, прикрой»" },
            ...
            [101] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 90, Text = "Или же доверитесь выбору Коннери и примете предложение лепрекона (сразу отнимите у себя три золотых)" },
                    new Option { Destination = 118, Text = "Если у вас записано слово деньги, идите на" },
                }
            },
            [102] = new Paragraph
            {
            ...
            [103] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 49, Text = "или дадите, наконец, Коннери высказаться" },
                }
            },
            [104] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 62, Text = "или нет" },
                }
            },
            [105] = new Paragraph
            {
            ...
            [106] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 68, Text = "Как по-вашему, стоит ли немедленно броситься на поиски" },
                    new Option { Destination = 113, Text = "или же аккуратно одеться, почистить зубы нитью и не спеша выйти из пещеры" },
                }
            },
            [107] = new Paragraph
            {
            ...
            [108] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 172, Text = "Прямо по курсу виден мост, переброшенный через каньон, но уж издалека он выглядит, мягко говоря, ненадежным" },
                    new Option { Destination = 128, Text = "Левее бежит тропинка, уводящая вдоль реки на северо-восток" },
                }
            },
            [109] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 93, Text = "Вы будете продолжать поиски удобного места" },
                    new Option { Destination = 37, Text = "или вернетесь к сухому дереву и заночуете там" },
                }
            },
            [110] = new Paragraph
            {
            ...
            [112] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 31, Text = "или пройдете мимо" },
                }
            },
            [113] = new Paragraph
            {
            ...
            [118] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 19, Text = "или откажетесь от предложения лепрекона" },
                }
            },
            [119] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 45, Text = "или нет" },
                }
            },
            [120] = new Paragraph
            {
            ...
            [123] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 306, Text = "Если вы управились за 5 раундов, то" },
            ...
            [126] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 156, Text = "Вы можете двинуться прямо на север, в пологое ущелье, на дне которого струится туман" },
            ...
            [128] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 152, Text = "или нет" },
                }
            },
            [129] = new Paragraph
            {
            ...
            [131] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 179, Text = "или вдоль левой" },
                }
            },
            [132] = new Paragraph
            {
            ...
            [137] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 217, Text = "Будете прятаться за стеной, надеясь что все обойдется" },
                    new Option { Destination = 341, Text = "или войдете в крипту" },
                }
            },
            [138] = new Paragraph
            {
            ...
            [139] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 224, Text = "или оставите ему жизнь" },
                }
            },
            [140] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 151, Text = "Поинтересуетесь кто автор" },
                    new Option { Destination = 127, Text = "или о чем сложена эта баллада" },
                }
            },
            [141] = new Paragraph
            {
            ...
            [149] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 159, Text = "или попытаетесь разжать хватку" },
                }
            },
            [150] = new Paragraph
            {
            ...
            [154] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 384, Text = "Волк сейчас опять прыгнет, надо либо оттолкнуть стареющую легенду и принять удар на себя" },
                    new Option { Destination = 228, Text = "– Да что с тобой, совсем реакция пропала?" },
                }
            },
            [155] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 219, Text = "или метнетесь за своими вещами" },
                }
            },
            [156] = new Paragraph
            {
            ...
            [158] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 174, Text = "Как только в процессе боя ваш уровень ЖИЗНИ упадет до 6, то вы предпримете попытку убежать – идите на" },
                    new Option { Destination = 229, Text = "После уходите" },
                }
            },
            [159] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 223, Text = "Если ваша специализация воин, то" },
                    new Option { Destination = 201, Text = "Иначе" },
                }
            },
            [160] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 192, Text = "Может быть, стоит подняться обратно и выбрать другой маршрут, обойдя ущелье справа" },
                    new Option { Destination = 218, Text = "или слева" },
                    new Option { Destination = 131, Text = "Если вы решите продолжить спуск, идите на" },
                }
            },
            [161] = new Paragraph
            {
            ...
            [162] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 321, Text = "Если у вас записано слово сфера, идите на" },
                    new Option { Destination = 230, Text = "Если у вас есть ржавый кинжал , идите на" },
                    new Option { Destination = 215, Text = "Иначе остается только предложить ему заточить ваш меч" },
                }
            },
            [163] = new Paragraph
            {
            ...
            [168] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 204, Text = "то ли исследовать пещеру" },
                    new Option { Destination = 216, Text = "то ли не искать приключений на свою пятую точку и продолжить свой путь (тогда вернитесь на" },
                }
            },
            [169] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 136, Text = "Ваш выбор север" },
                    new Option { Destination = 285, Text = "или северо-восток" },
                }
            },
            [170] = new Paragraph
            {
            ...
            [171] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 274, Text = "Левее, на северо-западе, лежит скучная равнина, однообразие которой нарушают лишь два высоких каменных идола, далеко отстоящие друг от друга" },
                    new Option { Destination = 188, Text = "Прямо по курсу – набившие оскомину скалистые холмы" },
                }
            },
            [172] = new Paragraph
            {
            ...
            [177] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 198, Text = "или ударить плашмя и заорать, просто отвлекая его внимание" },
                }
            },
            [178] = new Paragraph
            {
            ...
            [181] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 144, Text = "Если ваша специализация метатель, то у вас, может, что-то из этой затеи и выйдет" },
                    new Option { Destination = 292, Text = "Если же вы воин или маг, то ничего у вас не получается, остается только принять бой" },
                }
            },
            [182] = new Paragraph
            {
            ...
            [188] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 381, Text = "Итак, вы все же поможете великану" },
                    new Option { Destination = 388, Text = "или тихо скроетесь меж камней и продолжите свой путь" },
                }
            },
            [189] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 304, Text = "Если у вас записано слово высший, идите на" },
                    new Option { Destination = 377, Text = "Иначе остается сражаться" },
                    new Option { Destination = 247, Text = "или попытаться выбраться из пещеры" },
                }
            },
            [190] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 220, Text = "Вы будете удерживать брыкающегося напарника" },
                    new Option { Destination = 258, Text = "или ослабите захват, позволив ему сделать то, что он собирался" },
                }
            },
            [191] = new Paragraph
            {
            ...
            [192] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 211, Text = "или метнетесь влево, чтобы посмотреть как там Коннери" },
                }
            },
            [193] = new Paragraph
            {
            ...
            [195] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 161, Text = "Если у вас записано слово настой, идите на" },
                    new Option { Destination = 207, Text = "Иначе остается лишь прихватить пергамент с собой и выбрать направление движения" },
                }
            },
            [196] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 480, Text = "Шагаете вперед и вонзаете меч в жреца горного клана" },
            ...
            [197] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 170, Text = "Когда вы поднимитесь обратно на ноги, все уже будет кончено" },
                }
            },
            [198] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 163, Text = "Или же рискнуть и все же попытаться сложить стихотворный ответ" },
                }
            },
            [199] = new Paragraph
            {
            ...
            [203] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 184, Text = "Вы успеваете отпрыгнуть с пути несущегося стада, но в какую сторону? Вправо" },
                    new Option { Destination = 166, Text = "или влево" },
                }
            },
            [204] = new Paragraph
            {
            ...
            [207] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 287, Text = "Вы, правда, ничего подобного не слышите" },
                    new Option { Destination = 252, Text = "Правее, в низине на северо-востоке находится небольшое прозрачное озеро" },
                }
            },
            [208] = new Paragraph
            {
            ...
            [212] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 142, Text = "или останетесь в обуви" },
                }
            },
            [213] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 245, Text = "Если вы выбрали второй вариант, идите на" },
                    new Option { Destination = 335, Text = "Иначе ваш выбор неверен, и вам дорога на" },
                }
            },
            [214] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 234, Text = "или бежать по тропе к повороту" },
                }
            },
            [215] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 315, Text = "Если ваша специализация маг, то идите на" },
            ...
            [216] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 168, Text = "Если у вас записано слово дерн, идите на" },
                    new Option { Destination = 274, Text = "Правее же, на северо-востоке видна скучная равнина, однообразие которой нарушают лишь два высоких каменных идола, далеко отстоящие друг от друга" },
                }
            },
            [217] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 277, Text = "Если у вас записано слово пружинка, то" },
                    new Option { Destination = 174, Text = "Иначе остается лишь обнажить меч и встать у ворот, чтобы срезать того, кто рискнет заехать первым" },
                }
            },
            [218] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 139, Text = "Если бой затянется дольше 10 раундов, то" },
                    new Option { Destination = 248, Text = "Если вы справились раньше, то" },
                }
            },
            [219] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 284, Text = "Или окликните напарника" },
                }
            },
            [220] = new Paragraph
            {
            ...
            [229] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 386, Text = "Вполне возможно, что из нее она и состоит" },
                    new Option { Destination = 216, Text = "Левее, на северо-западе, видна причудливая скала, изогнутая аркой наподобие буквы Л" },
                    new Option { Destination = 375, Text = "А забрав правее, вы непременно придете к чахлой рощице из слабых, причудливо изогнутых деревьев" },
                }
            },
            [230] = new Paragraph
            {
            ...
            [231] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 395, Text = "Вы свернете вслед за ручьем и направитесь к гейзерам" },
                    new Option { Destination = 373, Text = "или пойдете прямо на север, поднимаясь на поросшую кустарником возвышенность" },
                }
            },
            [232] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 320, Text = "Если у вас записано слово Огадар, идите на" },
            ...
            [234] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 351, Text = "Вы будете возвращаться и прыгать" },
                    new Option { Destination = 329, Text = "Или попробуете спуститься по берегу вдоль реки" },
                }
            },
            [235] = new Paragraph
            {
            ...
            [236] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 312, Text = "Или все же разделитесь с напарником, чтобы зайти с разных сторон" },
                }
            },
            [237] = new Paragraph
            {
            ...
            [244] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 275, Text = "Попробуете вытащить мост" },
                    new Option { Destination = 390, Text = "Броситесь в реку" },
                    new Option { Destination = 374, Text = "Если Коннери еще жив, он доберется до храма самостоятельно, там вы его и подождете" },
                }
            },
            [245] = new Paragraph
            {
            ...
            [249] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 331, Text = "или просканируете окрестности заклинанием ВЗОР" },
                }
            },
            [250] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 267, Text = "Если у вас записано слово паника, идите на" },
            ...
            [251] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 294, Text = "Если у вас записано слово милосердие, идите на" },
                    new Option { Destination = 348, Text = "Иначе" },
                }
            },
            [252] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 149, Text = "Если у вас записано слово слезы, идите на" },
                    new Option { Destination = 126, Text = "Иначе" },
                }
            },
            [253] = new Paragraph
            {
            ...
            [255] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 424, Text = "Может быть стоит принести жертву второму идолу и послушать, что он скажет (если у вас конечно есть еще 10 золотых)" },
                    new Option { Destination = 388, Text = "Если нет, остается лишь уходить" },
                }
            },
            [256] = new Paragraph
            {
            ...
            [258] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 298, Text = "Если у вас записано слово должок, идите на" },
                    new Option { Destination = 354, Text = "Если у вас записано слово учеба, идите на" },
                    new Option { Destination = 123, Text = "Иначе остается только бой" },
                }
            },
            [259] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 332, Text = "или что-нибудь наврете, чтобы не выглядеть дураком-фантазером" },
                }
            },
            [260] = new Paragraph
            {
            ...
            [261] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 301, Text = "Вы броситесь наперерез, чтобы остановить носорога" },
                    new Option { Destination = 241, Text = "или же прыгнете к Коннери, чтобы убрать его с дороги" },
                }
            },
            [262] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 195, Text = "Пока не истекли ваши пять минут, вы можете быстро осмотреть кости" },
                    new Option { Destination = 281, Text = "или обогнуть скалу, чтобы посмотреть, что же там оставляют магнитке великаны" },
                }
            },
            [263] = new Paragraph
            {
            ...
            [270] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 226, Text = "Если у вас записано слово сглаз, идите на" },
                    new Option { Destination = 345, Text = "Вы все же двинетесь по ней" },
                    new Option { Destination = 387, Text = "Или, воспользовавшись тем, что у вас теперь есть посох, чтобы проверять дорогу, двинетесь по зыбкому торфу, забирая левее от источника жуткого рева" },
                }
            },
            [271] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 138, Text = "Вы попробуете поставить ему подножку, когда он уходит" },
                    new Option { Destination = 155, Text = "или, пользуясь случаем, попытаетесь ногой подтянуть к себе один из его инструментов" },
                }
            },
            [272] = new Paragraph
            {
            ...
            [274] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 364, Text = "или бегом рванетесь вперед" },
                }
            },
            [275] = new Paragraph
            {
            ...
            [276] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 260, Text = "или нет" },
                }
            },
            [277] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 341, Text = "или рискнете исследовать крипту" },
                }
            },
            [278] = new Paragraph
            {
            ...
            [279] = new Paragraph
            {
                ...
                {
                    new Option { Destination = 304, Text = "Если у вас записано слово высший, идите на" },
                    new Option { Destination = 377, Text = "Иначе остается либо принять свой, скорее всего – последний, бой" },
                    new Option { Destination = 247, Text = "либо попытаться выбежать из пещеры на свет" },
                }
            },
            [280] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 242, Text = "или бросить прутик, отказываясь играть в непонятные игры" },
                }
            },
            [281] = new Paragraph
            {
            ...
            [285] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 158, Text = "Или предпочтете его обогнуть" },
                }
            },
            [286] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 370, Text = "или же займетесь более насущными вещами? В таком случае вернитесь на" },
                }
            },
            [287] = new Paragraph
            {
            ...
            [291] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 311, Text = "Вы можете подойти поближе, чтобы разглядеть, кто это" },
                    new Option { Destination = 349, Text = "или вы предпочтете дать крюк, чтобы не вступать в контакт с неведомым аборигеном" },
                }
            },
            [292] = new Paragraph
            {
            ...
            [297] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 387, Text = "или предпочтете обойти холмы, сделав крюк по зыбкому болотистому торфянику" },
                }
            },
            [298] = new Paragraph
            {
            ...
            [299] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 270, Text = "Или же свернете к дереву, чтобы сначала выломать себе подходящий посох – незаменимую вещь во время променада по зыбкой местности" },
                }
            },
            [300] = new Paragraph
            {
            ...
            [306] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 176, Text = "Вы решите, что лучше встретить смерть с мечом в руках, и примете бой над телом напарника" },
                    new Option { Destination = 266, Text = "или наплюете на арифметику и будете тащить Коннери к разверзнутой пасти, невзирая ни на что" },
                }
            },
            [307] = new Paragraph
            {
            ...
            [310] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 330, Text = "или идем ему навстречу" },
                }
            },
            [311] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 242, Text = "Вы предложите побыстрее уйти" },
                    new Option { Destination = 280, Text = "или подойти ближе" },
                }
            },
            [312] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 283, Text = "Вы можете добавить гному затрещину от себя" },
                    new Option { Destination = 347, Text = "или же самостоятельно открыть один из ящиков" },
                }
            },
            [313] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 261, Text = "Вы можете полоснуть его мечом по шее" },
                    new Option { Destination = 295, Text = "или вырубить, ударив ногой в основание черепа" },
                }
            },
            [314] = new Paragraph
            {
            ...
            [315] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 278, Text = "Давай клинок, если согласен" },
                    new Option { Destination = 383, Text = "или уходи" },
                }
            },
            [316] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 253, Text = "Вы тихо ретируетесь, пока им не до вас" },
                    new Option { Destination = 336, Text = "или же рискнете посмотреть, что будет дальше" },
                }
            },
            [317] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 328, Text = "Вы можете сказать «пожалуйста»" },
                    new Option { Destination = 262, Text = "или «два весла тебе в рот, гнида мелкопакостная»" },
                }
            },
            [318] = new Paragraph
            {
            ...
            [321] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 383, Text = "Если у вас нет таких денег, идите на" },
            ...
            [327] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 309, Text = "Если вы подобрали именно эти слова, идите на" },
                    new Option { Destination = 235, Text = "Если нет, то стих у вас получится откровенно кособокий, и вам дорога на" },
                }
            },
            [328] = new Paragraph
            {
            ...
            [329] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 141, Text = "Если у вас записано слово записка, то идите на" },
                    new Option { Destination = 393, Text = "Если решите понырять, чтобы проверить, не ушло ли тело Коннери на глубину (мало ли, вдруг треснулся головой, пока его несло течением), то" },
                    new Option { Destination = 379, Text = "Если решите форсировать реку, и проверить, нет ли следов напарника на другой стороне, то" },
                }
            },
            [330] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 313, Text = "Вы сжимаете меч и бросаетесь на выбитого из седла гиганта" },
                    new Option { Destination = 269, Text = "или на носорога" },
                }
            },
            [331] = new Paragraph
            {
            ...
            [334] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 285, Text = "Вы пойдете прямо" },
                    new Option { Destination = 350, Text = "свернете направо" },
                    new Option { Destination = 136, Text = "или направитесь левее" },
                }
            },
            [335] = new Paragraph
            {
            ...
            [336] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 253, Text = "Или тихо ретироваться, пока вас не заметили" },
                }
            },
            [337] = new Paragraph
            {
            ...
            [339] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 265, Text = "или же послушаете Коннери и удержитесь от агрессии" },
                }
            },
            [340] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 553, Text = "Если у вас есть кусок малахита , и вы не прочь рискнуть, то" },
            ...
            [342] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 129, Text = "Если же вам удалось оторваться, то" },
                }
            },
            [343] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 273, Text = "или не будете этого делать, решив сначала разобраться со своими соперниками" },
                }
            },
            [344] = new Paragraph
            {
            ...
            [345] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 318, Text = "или нет" },
                }
            },
            [346] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 317, Text = "Если у вас записано слово болтовня, идите на" },
                    new Option { Destination = 302, Text = "Если ваша специализация – воин, идите на" },
                    new Option { Destination = 165, Text = "Если же все эти варианты вам не подходят, то идите на" },
                }
            },
            [347] = new Paragraph
            {
            ...
            [348] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 167, Text = "Если у вас записано слово встреча, идите на" },
                    new Option { Destination = 337, Text = "Если нет, то" },
                }
            },
            [349] = new Paragraph
            {
            ...
            [350] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 375, Text = "на север, где виднеется чахлая рощица из слабых, причудливо изогнутых деревьев" },
                    new Option { Destination = 386, Text = "или заберете левее, к ярко блестящей на солнце скале" },
                }
            },
            [351] = new Paragraph
            {
            ...
            [352] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 274, Text = "Прямо по курсу лежит скучная равнина, однообразие которой нарушают лишь два высоких каменных идола, далеко отстоящие друг от друга" },
                    new Option { Destination = 188, Text = "Правее, на северо-востоке, опять скалистые холмы" },
                }
            },
            [353] = new Paragraph
            {
            ...
            [355] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 393, Text = "Итак, вы ушли под воду" },
                    new Option { Destination = 305, Text = "или очутились на другом берегу" },
                }
            },
            [356] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 257, Text = "Вы будете упорствовать, настаивая на своем" },
                    new Option { Destination = 319, Text = "или все же дадите ему возможность разогнать медуз громким криком" },
                }
            },
            [357] = new Paragraph
            {
            ...
            [360] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 325, Text = "Если все в порядке, идите на" },
                    new Option { Destination = 380, Text = "Если нет, то еще есть крохотный шанс поставить ЗАСЛОН" },
                    new Option { Destination = 314, Text = "Если же и заклинаний в запасе у вас нет, или вы из экономии не хотите этого делать, то" },
                }
            },
            [361] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 264, Text = "В качестве извинений могу рассказать тебе сказку" },
                    new Option { Destination = 382, Text = "или просто дать дельный совет" },
                }
            },
            [362] = new Paragraph
            {
            ...
            [363] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 399, Text = "Можно попробовать подняться наверх и исследовать верхний ярус башни" },
                    new Option { Destination = 157, Text = "или же вы предпочтете остаться на месте, развлекаясь разглядыванием трещин в стене" },
                }
            },
            [364] = new Paragraph
            {
            ...
            [368] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 154, Text = "Вы попытаетесь уйти в сторону, чтобы дать напарнику показать себя" },
                    new Option { Destination = 384, Text = "либо не будете рисковать и встретите волка ударом меча" },
                }
            },
            [369] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 133, Text = "или пойдете дальше по дороге" },
                }
            },
            [370] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 286, Text = "Если у вас записано слово записка, идите на" },
                    new Option { Destination = 393, Text = "Если нет, то вы либо можете нырнуть, чтобы рассмотреть, нет ли на дне тела Коннери" },
                    new Option { Destination = 338, Text = "либо выбраться на берег" },
                }
            },
            [371] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 386, Text = "Скоро полдень, и вы ускоряете шаг, держа курс на северо-восток по направлению к ярко блестящей на солнце скале" },
                    new Option { Destination = 216, Text = "или на север, избрав ориентиром чудную скалу, изгибающуюся похожей на букву Л аркой" },
                }
            },
            [372] = new Paragraph
            {
            ...
            [375] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 323, Text = "Иначе остается лишь схватка" },
                }
            },
            [376] = new Paragraph
            {
            ...
            [378] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 356, Text = "Вы попробуете ему помешать" },
            ...
            [379] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 338, Text = "Как вы это сделаете — вплавь (но от одного лишь взгляда на эту холодную горную речку у вас мурашки)" },
                    new Option { Destination = 355, Text = "или рискнете пропрыгать по камням (скользкие и угловатые валуны выглядят не очень-то надежной опорой для ног)" },
                }
            },
            [380] = new Paragraph
            {
            ...
            [384] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 308, Text = "Если вы уложились за пять раундов, то успеваете убежать с поля боя до подхода подкрепления" },
                    new Option { Destination = 359, Text = "И лучше бы вам поторопиться, потому как если вы не уложитесь в отведенное время, то вам дорога на" },
                }
            },
            [385] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 361, Text = "Если же ваша специализация – метатель ножей, то вам дорога на" },
            ...
            [386] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 352, Text = "Если нет, то вы спокойно проходите мимо, скорчив отражению забавную рожицу" },
                }
            },
            [387] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 232, Text = "Вы продолжите движение вперед, понимая, что в таком случае бой неизбежен" },
                    new Option { Destination = 365, Text = "либо, в ту же секунду, как заметили великана, броситесь в заросли высокой травы неподалеку, чтобы укрыться там" },
                }
            },
            [388] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 174, Text = "Вы двинетесь к воротам, решив испробовать старую как мир тактику – вперед, напролом, а там разберемся" },
            ...
            [392] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 255, Text = "Вы отнесете деньги правому идолу (также вместо 10 золотых можно использовать драгоценности – ожерелье с изумрудами или кольцо с рубином , если у вас, конечно, есть такие вещи)" },
                    new Option { Destination = 246, Text = "левому" },
                    new Option { Destination = 364, Text = "или броситесь бежать (если у вас нет денег или желания быть меценатом)" },
                }
            },
            [393] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 372, Text = "либо нырнуть еще раз, чтобы рассмотреть блеснувшую вещь" },
                }
            },
            [394] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 387, Text = "Если же вы решите рискнуть, можете прогуляться по равнине, выбрав ориентиром одинокий холм, возвышающийся левее по курсу" },
                }
            },
            [395] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 153, Text = "или заберетесь на камень" },
                }
            },
            [396] = new Paragraph
            {
            ...
            [398] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 357, Text = "Если у вас есть принт , то идите на" },
                    new Option { Destination = 376, Text = "Будете щипать себя" },
                    new Option { Destination = 256, Text = "или шарахнете себе же в ногу СГУСТКОМ" },
                }
            },
            [399] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 222, Text = "или нет" },
                }
            },
            [400] = new Paragraph
            {
            ...
            [401] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 462, Text = "Или вы рискнете двигаться наобум" },
                }
            },
            [402] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 432, Text = "Вы можете согласиться с «теорией радуги»" },
                    new Option { Destination = 454, Text = "или предложить свое решение" },
            ...
            [418] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 529, Text = "Если у вас записано слово слезы, или водоем, или ярость, то идите на" },
                    new Option { Destination = 539, Text = "Если у вас записано слово нюансы, идите на" },
                }
            },
            [419] = new Paragraph
            {
            ...
            [420] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 480, Text = "– Стой! Смотри, я иду, и со мной ничего не происходит" },
                }
            },
            [421] = new Paragraph
            {
            ...
            [427] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 480, Text = "Пойдете по коридору вправо, по направлению к изящной кирпичной арке" },
                    new Option { Destination = 504, Text = "влево" },
                    new Option { Destination = 196, Text = "из обожженной глины" },
                    new Option { Destination = 458, Text = "из дерева, изящно украшенного резьбой" },
                    new Option { Destination = 340, Text = "из черного камня с малахитовыми вкраплениями" },
                }
            },
            [428] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 443, Text = "Итак, вы рискнете пройти сквозь барьер, раздевшись и вывалявшись в песке" },
                    new Option { Destination = 599, Text = "или же перейдете к плану с муравейником" },
                }
            },
            [429] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 451, Text = "Если ваша специализация – магия, то" },
                    new Option { Destination = 410, Text = "Иначе –" },
                }
            },
            [430] = new Paragraph
            {
            ...
            [431] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 475, Text = "либо преодолеть оставшееся расстояние двумя гигантскими прыжками" },
                }
            },
            [432] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 440, Text = "или же на напарника" },
                }
            },
            [433] = new Paragraph
            {
            ...
            [436] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 541, Text = "или же резко отпрыгнуть в сторону" },
                    new Option { Destination = 593, Text = "СГУСТОК" },
                    new Option { Destination = 557, Text = "Если ваша специализация метатель, то" },
                }
            },
            [437] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 425, Text = "Надо решать как можно скорее – преодолеть оставшийся отрезок тем же способом" },
                    new Option { Destination = 490, Text = "или выпрямиться в полный рост" },
                }
            },
            [438] = new Paragraph
            {
            ...
            [441] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 480, Text = "– Бросить золотую монету" },
                    new Option { Destination = 493, Text = "Или вернитесь на" },
                }
            },
            [442] = new Paragraph
            {
            ...
            [447] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 439, Text = "Вы за то, чтобы продолжать движение по правой стене" },
                    new Option { Destination = 421, Text = "перейдете к левой" },
                    new Option { Destination = 416, Text = "или двинетесь по центру коридора, повернувшись боком, чтобы стать как можно более плоским" },
                }
            },
            [448] = new Paragraph
            {
            ...
            [452] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 517, Text = "или нет" },
                }
            },
            [453] = new Paragraph
            {
            ...
            [454] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 426, Text = "либо вы оба наступаете на одну" },
                }
            },
            [455] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 480, Text = "Если у вас записано слово такт, то идите на" },
                    new Option { Destination = 513, Text = "Иначе остается лишь испытать скорость своей реакции и попытаться пройти зал манекенов (если хотите, можете заранее наложить заклинание БРОНЯ, в таком случае на следующем параграфе вы потеряете вдвое меньше ЖИЗНЕЙ)" },
                }
            },
            [456] = new Paragraph
            {
            ...
            [457] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 409, Text = "Если ваша специализация маг, то" },
                    new Option { Destination = 524, Text = "Вы будете настаивать на своем – в этом случае вы возвращаетесь и следуете другим путем" },
                    new Option { Destination = 506, Text = "или согласитесь идти дальше" },
                }
            },
            [458] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 353, Text = "Войти удастся только в том случае, если у вас есть медный ключ" },
                    new Option { Destination = 427, Text = "Иначе возвращайтесь на" },
                }
            },
            [459] = new Paragraph
            {
            ...
            [463] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 431, Text = "или нет" },
                }
            },
            [464] = new Paragraph
            {
            ...
            [465] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 589, Text = "Или затормозите и подождете Коннери" },
                }
            },
            [466] = new Paragraph
            {
            ...
            [470] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 435, Text = "Если у вас записано слово схрон, то" },
                    new Option { Destination = 480, Text = "Попробуете взобраться по стене к потолку и проверить, как обстоят дела там" },
                    new Option { Destination = 493, Text = "Или вернетесь на" },
                }
            },
            [471] = new Paragraph
            {
            ...
            [474] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 484, Text = "или с сожалением повесите его обратно на стену" },
                }
            },
            [475] = new Paragraph
            {
            ...
            [477] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 442, Text = "Вековая тишина с неохотой уступает место звукам ваших шагов(если у вас записано слово корзинка, идите на" },
                    new Option { Destination = 600, Text = "Сами вы в этом далеко не уверены" },
                }
            },
            [478] = new Paragraph
            {
            ...
            [480] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 418, Text = "За вашими спинами, шурша истлевшими одеяниями, восстает с пола проклятый когда-то король, чтобы вновь занять свой пост" },
                    new Option { Destination = 537, Text = "Отсмеявшись свое, вы идете дальше" },
                    new Option { Destination = 453, Text = "Вы подойдете и попробуете оказать ему помощь" },
                    new Option { Destination = 537, Text = "Или тихо перейдете мост, пока ловушка обезврежена и проследуете дальше" },
                    new Option { Destination = 509, Text = "Что ж, между вами и выходом больше, кажется, не осталось никаких преград" },
                    new Option { Destination = 504, Text = "Переглянувшись с Коннери, вы поворачиваетесь и бросаетесь бежать по коридору, в противоположную от арки сторону" },
                    new Option { Destination = 583, Text = "Вы явно избежали какой-то ловушки, хоть и непонятно, в чем она заключалась" },
                    new Option { Destination = 506, Text = "Вы без особых проблем минуете последнюю колонну и покидаете зал" },
                    new Option { Destination = 571, Text = "Если у вас записано слово железняк, идите на" },
                    new Option { Destination = 412, Text = "Иначе" },
                    new Option { Destination = 535, Text = "Надо пробиваться к выходу" },
                    new Option { Destination = 493, Text = "Вернитесь на" },
                    new Option { Destination = 441, Text = "Вернитесь на" },
                }
            },
            [481] = new Paragraph
            {
            ...
            [482] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 503, Text = "Если у вас записано слово песок, идите на" },
                    new Option { Destination = 493, Text = "Вернитесь на" },
                }
            },
            [483] = new Paragraph
            ...
            [484] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 480, Text = "Делаете шаг вправо к стойкам с оружием" },
            ...
            [496] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 468, Text = "или нет" },
                }
            },
            [497] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 530, Text = "или перейдем ручей вброд" },
                }
            },
            [498] = new Paragraph
            {
            ...
            [500] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 456, Text = "Если у вас есть шахтерскаярукавица и вода во фляге, то" },
                    new Option { Destination = 548, Text = "Если нет, то" },
                }
            },
            [501] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 414, Text = "или будете, скрепя зубы, наблюдать за дальнейшим ходом поединка" },
                }
            },
            [502] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 538, Text = "Если ваша специализация метатель, то" },
                    new Option { Destination = 532, Text = "СГУСТОК" },
                    new Option { Destination = 478, Text = "Иначе остается лишь броситься обратно, стараясь ступать по своим следам" },
                }
            },
            [503] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 599, Text = "Если вы хотите рискнуть и побарахтаться в муравейнике, то" },
                    new Option { Destination = 493, Text = "Иначе вернитесь на" },
                }
            },
            [504] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 477, Text = "Если вы будете настаивать на своем, то Коннери вынужден будет последовать за вами – разделяться сейчас смерти подобно" },
                    new Option { Destination = 438, Text = "Если вы послушаете напарника и двинетесь к двери, то идите на" },
                }
            },
            [505] = new Paragraph
            {
            ...
            [506] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 480, Text = "Вы выберете правый, из которого слышен шум воды" },
                    new Option { Destination = 455, Text = "или ничем не примечательный левый" },
                }
            },
            [507] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 576, Text = "или шагнете к Коннери, чтобы придержать его" },
                }
            },
            [508] = new Paragraph
            {
            ...
            [509] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 565, Text = "Вы попробуете протиснуться наружу" },
                    new Option { Destination = 591, Text = "или последуете за Коннери" },
                }
            },
            [510] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 577, Text = "Если вы сегодня убили в бою хоть кого-нибудь, любое существо – идите на" },
                    new Option { Destination = 537, Text = "Если нет – то ничего не произошло, немедленно вернитесь на" },
                }
            },
            [511] = new Paragraph
            {
            ...
            [514] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 493, Text = "или предпочтете вернуться на" },
                }
            },
            [515] = new Paragraph
            {
            ...
            [519] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 480, Text = "попытаться уйти в сторону" },
                }
            },
            [520] = new Paragraph
            {
            ...
            [523] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 474, Text = "Вы подойдете к отделу с оружием гномов" },
                    new Option { Destination = 542, Text = "полюбуетесь на эльфийские клинки" },
                    new Option { Destination = 484, Text = "или же ваше чутье велит вам ничего не трогать и побыстрее покинуть комнату" },
                }
            },
            [524] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 480, Text = "Вы пойдете справа от колонны" },
                    new Option { Destination = 596, Text = "или слева" },
                }
            },
            [525] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 428, Text = "Если у вас записано слово догадка, то" },
                    new Option { Destination = 493, Text = "Лучше попробовать что-то другое – вернитесь на" },
                }
            },
            [526] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 480, Text = "Далее вы предложите себя на роль поединщика" },
                    new Option { Destination = 501, Text = "уступите напарнику честь убрать преграду с вашего пути" },
                    new Option { Destination = 414, Text = "или решите, что проще всего подгнившего короля будет победить вдвоем" },
                }
            },
            [527] = new Paragraph
            {
            ...
            [534] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 495, Text = "Если вы расположили вещи так: Быммуным – меч, Берилионидин – цепь, Браккус – череп, то идите на" },
                    new Option { Destination = 508, Text = "Если вы расположили вещи так: Быммуным – череп, Берилионидин – меч, Браккус – цепь, то идите на" },
                    new Option { Destination = 572, Text = "Если вы расположили вещи как-то иначе, то идите на" },
                }
            },
            [535] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 452, Text = "Если вы справились за 6 раундов или меньше (а если у вас записано слово задержка, то это означает, что времени у вас еще меньше – вам надо справиться за 5 раундов), то" },
                    new Option { Destination = 512, Text = "Если не успели, то" },
                }
            },
            [536] = new Paragraph
            {
            ...
            [537] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 561, Text = "Грубо вырезанная богиня с четырьмя руками изогнулась в танце, насмешливый взгляд ее словно говорит – не ошибись в выборе, ведьмак (если у вас записано слово сказка, идите на" },
            ...
            [539] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 433, Text = "Вы подойдете ближе" },
                    new Option { Destination = 492, Text = "или начнете медленно, осторожно пятиться назад" },
                }
            },
            [540] = new Paragraph
            {
            ...
            [547] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 493, Text = "или бросите свою затею и вернетесь на" },
                }
            },
            [548] = new Paragraph
            {
            ...
            [549] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 491, Text = "(Если у вас записано слово пропажа, идите на" },
            ...
            [551] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 574, Text = "Если его уровень его ДОВЕРИЯ меньше 6, то он откажется от такой авантюры – сразу идите на" },
                    new Option { Destination = 540, Text = "Вернитесь на" },
                }
            },
            [552] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 598, Text = "Вы рванете как ветер, чтобы быстрее миновать опасное место" },
                    new Option { Destination = 559, Text = "Пройдете вдоль левой стены, прижавшись к ней спиной, чтобы уменьшить зону поражения" },
                    new Option { Destination = 581, Text = "Если у вас записано слово шарик, то" },
                }
            },
            [553] = new Paragraph
            {
            ...
            [555] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 592, Text = "Если у вас записано слово оберег, идите на" },
                    new Option { Destination = 569, Text = "Иначе ступайте на" },
                }
            },
            [556] = new Paragraph
            {
            ...
            [561] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 537, Text = "Если нет, то вернитесь на" },
                }
            },
            [562] = new Paragraph
            {
            ...
            [576] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 480, Text = "Останетесь на месте" },
            ...
            [582] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 477, Text = "Вы будете настаивать на том, чтобы бежать дальше по коридору" },
                    new Option { Destination = 427, Text = "или согласитесь с напарником и подниметесь по лестнице" },
                }
            },
            [583] = new Paragraph
            {
            ...
            [585] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 493, Text = "Если вы сумели набрать необходимый вес, то без проблем покидаете комнату с весами, и идете по коридору до золотистой двери" },
                    new Option { Destination = 556, Text = "Это будет Коннери" },
                    new Option { Destination = 521, Text = "или вы сами" },
                }
            },
            [586] = new Paragraph
            {
            ...
            [588] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 562, Text = "или нет" },
                }
            },
            [589] = new Paragraph
            {
            ...
            [592] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 578, Text = "Если у вас в вещах есть старый бронзовый наруч , то идите на" },
                    new Option { Destination = 543, Text = "Иначе" },
                }
            },
            [593] = new Paragraph
            {
            ...
            [595] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 554, Text = "Если у вас записаны все эти слова: один, два, три, четыре, пять, то идите на" },
                    new Option { Destination = 519, Text = "Если у вас записаны четыре из этих слов, а какого-то одного не хватает, то идите на" },
                    new Option { Destination = 509, Text = "Если ни одни из вариантов, приведенных выше, не про вас, то ваш спринт был безупречен, и вам прямая дорога на" },
                }
            },
            [596] = new Paragraph
            {
            ...
            [603] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 619, Text = "Если у вас записано слово дыхание, идите на" },
                    new Option { Destination = 628, Text = "Иначе" },
                }
            },
            [604] = new Paragraph
            {
            ...
            [606] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 661, Text = "Если ваши рефлексы подведут вас, то снаряд достигнет своей цели" },
                    new Option { Destination = 638, Text = "если у вас в руках орочий яхан, то вам дорога на" },
                    new Option { Destination = 652, Text = "Если же обычный ведьмачий меч, то" },
                }
            },
            [607] = new Paragraph
            {
            ...
            [613] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 637, Text = "Если у вас записано слово идолы, то идите на" },
                    new Option { Destination = 620, Text = "Если нет, то" },
                }
            },
            [614] = new Paragraph
            {
            ...
            [615] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 665, Text = "Если его ДОВЕРИЕ равно 10 или больше, то идите на" },
                    new Option { Destination = 632, Text = "Если меньше, то" },
                }
            },
            [616] = new Paragraph
            {
            ...
            [619] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 618, Text = "Вы предпримете еще одну попытку пробить доспехи" },
                    new Option { Destination = 684, Text = "Или решите, что тут дело нечисто, и надо действовать как-то по-другому" },
                }
            },
            [620] = new Paragraph
            {
            ...
            [629] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 653, Text = "Если вы решите применить СГУСТОК, то" },
            ...
            [630] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 679, Text = "или нет" },
                }
            },
            [631] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 677, Text = "Если ваша специализация – метатель, то" },
            ...
            [635] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 601, Text = "Такое ощущение, что вы бьетесь против карусели из лезвий (если у вас записано слово учеба, идите на" },
            ...
            [643] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 697, Text = "Если его ДОВЕРИЕ 7 или больше, то" },
                    new Option { Destination = 647, Text = "Вы отчаянно бросаете ковер вниз и вперед, пытаясь поймать молот и понимая, что безнадежно опаздываете" },
                }
            },
            [644] = new Paragraph
            {
            ...
            [647] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 661, Text = "Если нет, то" },
                }
            },
            [648] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 667, Text = "Если ваша специализация – воин, то идите на" },
                    new Option { Destination = 661, Text = "Если же нет, то камень вам не сдвинуть ни на дюйм и шар ударит в свою цель" },
                }
            },
            [649] = new Paragraph
            {
            ...
            [651] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 685, Text = "или отчаянно крикнете что-нибудь ободряющее Браннибору" },
                }
            },
            [652] = new Paragraph
            {
            ...
            [653] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 658, Text = "или рискнете прямо сейчас" },
                }
            },
            [654] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 664, Text = "Если у вас есть белая корона , то" },
                    ...
                    new Option { Destination = 620, Text = "Или же вы будете немногословны и молча, без изысков, поманите Тану мечом — жест, понятный всем и каждому" },
                }
            },
            [655] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 641, Text = "Или досчитаете до пяти, и прыгнете только потом, молясь при этом, чтобы леса не рухнули раньше" },
                }
            },
            [656] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 692, Text = "Если у вас записано слово братья, идите на" },
                    new Option { Destination = 643, Text = "Иначе" },
                }
            },
            [657] = new Paragraph
            {
            ...
            [658] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 607, Text = "Выпал чет, идите на" },
            ...
            [663] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 689, Text = "Если у вас есть рог марала илиизюбря , то" },
                    new Option { Destination = 617, Text = "Иначе" },
                }
            },
            [664] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 654, Text = "или не будете этого делать (тогда вернитесь на" },
                }
            },
            [665] = new Paragraph
            {
            ...
            [673] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 609, Text = "или нет" },
                }
            },
            [674] = new Paragraph
            {
            ...
            [675] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 698, Text = "Вы попытаетесь отговорить напарника" },
                    new Option { Destination = 640, Text = "или без лишних церемоний треснете его по голове, чтобы оглушить" },
                }
            },
            [676] = new Paragraph
            {
            ...
            [681] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 626, Text = "Вы поинтересуетесь, что ей нужно" },
                    new Option { Destination = 672, Text = "или проигнорируете ее и все-таки оглянетесь на жреца" },
                }
            },
            [682] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 661, Text = "или предпочтете укрыться за валуном" },
                }
            },
            [683] = new Paragraph
            {
            ...
            [687] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 568, Text = "Когда вы медленно сползаете на землю, у вас остается всего 1 ЖИЗНЬ! Если у вас еще есть ведьмачий Эликсир – немедленно выпейте его" },
                    new Option { Destination = 699, Text = "Если же нет" },
                }
            },
            [688] = new Paragraph
            {
            ...
            [697] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 647, Text = "или нет" },
                }
            },
            [698] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 661, Text = "Жаль, что эта история так нелепо заканчивается, – и вы остаетесь на месте" },
