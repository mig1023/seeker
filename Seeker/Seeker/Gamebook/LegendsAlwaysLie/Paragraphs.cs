    ...
    class Paragraphs : Interfaces.IParagraphs
    {
        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            [0] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 701, Text = "В путь!" },
                     new Option { Destination = 142, Text = "ТЕСТ" },
                     new Option { Destination = 247, Text = "ТЕСТ2" },
                      new Option { Destination = 269, Text = "ТЕСТ-реагир" },
                }
            },
            [1] = new Paragraph
            {
            ...
            [418] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 529, Text = "Если у вас записано слово слезы, или водоем, или ярость" },
            ...
            [420] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 480, Text = "Быстро пройдете вперед, крича напарнику: «Стой! Смотри, я иду, и со мной ничего не происходит!»" },
                }
            },
            [421] = new Paragraph
            {
