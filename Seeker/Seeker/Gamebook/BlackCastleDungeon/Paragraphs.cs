    ...
    class Paragraphs : Interfaces.IParagraphs
    {
        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            [0] = new Paragraph
            {
                ...
                {
                    new Option { Destination = 619, Text = "В путь!" },
                }
            },
            [1] = new Paragraph
            {
            ...
            [23] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 327, Text = "Заплатить ему", OnlyIf = "ЗОЛОТО >= 7" },
                    new Option { Destination = 217, Text = "Поищите в заплечном мешке подарок" },
                    new Option { Destination = 106, Text = "Вежливо поблагодарите и уйдете" },
            ...
            [142] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 443, Text = "Согласиться с предложением", OnlyIf = "ЗОЛОТО >= 2" },
            ...
            [255] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 79, Text = "1 золотой", OnlyIf = "ЗОЛОТО >= 1" },
                    new Option { Destination = 382, Text = "4 золотых", OnlyIf = "ЗОЛОТО >= 4" },
                    new Option { Destination = 495, Text = "6 золотых", OnlyIf = "ЗОЛОТО >= 6" },
            ...
            [351] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 574, Text = "Принять предложение", OnlyIf = "ЗОЛОТО >= 3" },
            ...
            [613] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 246, Text = "Согласиться", OnlyIf = "ЗОЛОТО >= 10" },
                    new Option { Destination = 65, Text = "Драться" },
                }
            },
            [614] = new Paragraph
