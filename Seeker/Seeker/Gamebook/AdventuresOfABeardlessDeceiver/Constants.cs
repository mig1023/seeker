...
namespace Seeker.Gamebook.AdventuresOfABeardlessDeceiver
{
    class Constants : Prototypes.Constants, Abstract.IConstants
    {
        ...
        public override string GetDescription() => "Алдар Косе (в переводе с тюркских " +
            "языков Безбородый Обманщик) – герой сказок и анекдотов кочевых народов Це" +
            "нтральной Азии. Великий хитрец и ловкач, он всегда стоит на страже справе" +
            "дливости, защищая бедный люд от произвола богачей и чиновников.\n\nВ этой" +
            " книге Алдар Косе должен выполнить важное поручение главы своего рода. И " +
            "вы можете ему в этом помочь. Вместе с героем вы будете путешествовать по " +
            "Великой степи, территории Казахского ханства и других государств XVII век" +
            "а, выбирая дорогу на свой вкус. Различные состязания по верховой езде и д" +
            "жигитовке, конкурсы степных поэтов и музыкантов, загадки мудрецов, борьба" +
            " и прочие испытания – всё это ждёт вас на страницах данной книги.";
