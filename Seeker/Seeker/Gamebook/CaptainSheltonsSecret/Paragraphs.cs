    ...
    class Paragraphs : Interfaces.IParagraphs
    {
        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            ...
            [104] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 330, Text = "Позвать их", OnlyIf = "Owl, Vulture" },
            ...
            [369] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 262, Text = "Вступить в бой самому" },
                }
            },
            [370] = new Paragraph
            {
            ...
            [429] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 487, Text = "Позвать моряка", OnlyIf = "Seaman" },
                    new Option { Destination = 171, Text = "Позвать воина Принца", OnlyIf = "PrinceWarrior" },
                    new Option { Destination = 284, Text = "Далее" },
                }
            },
            [430] = new Paragraph
            ...
            [476] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 534, Text = "Позвать моряка", OnlyIf = "Seaman" },
                    new Option { Destination = 218, Text = "Позвать воина Принца", OnlyIf = "PrinceWarrior" },
