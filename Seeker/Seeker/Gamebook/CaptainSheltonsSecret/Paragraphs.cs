    ...
    class Paragraphs : Interfaces.IParagraphs
    {
        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            ...
            [330] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 429, Text = "Ваши друзья победили Кондора" },
                    new Option { Destination = 570, Text = "Он убил их" },
                }
            },
            [331] = new Paragraph
            {
            ...
            [519] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 64, Text = "Если вы его убили" },
                }
            },
            [520] = new Paragraph
            {
