    ...
    class Paragraphs : Interfaces.IParagraphs
    {
        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            ...
            [204] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 757, Text = "В случае успеха" },
                    new Option { Destination = 766, Text = "В случае провала" },
                }
            },
            [205] = new Paragraph
            {
            ...
            [545] = new Paragraph
            {
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 605, Text = "Если отмечено ключевое слово «Запад», то караван через Заилийский Алатау готов двинуться в путь" },
