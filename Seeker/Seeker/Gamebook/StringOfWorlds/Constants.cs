...
namespace Seeker.Gamebook.StringOfWorlds
{
    class Constants : Prototypes.Constants, Abstract.IConstants
    {
        ...
        public override string GetDescription() => "Космический Патруль поднят по трев" +
            "оге - в лаборатории Мэрфи опять ЧП. Похищен образец сверхсекретного оружи" +
            "я. В роли отважного Майора Космического Патруля Вы пройдёте по Веренице М" +
            "иров (системе телепортации, связывающей ряд удаленных планет) в поисках п" +
            "охитителя. В этой книге Вас ожидают не только необыкновенные приключения " +
            "и замысловатые хитросплетения сюжета. Вы непременно оцените искрометный ю" +
            "мор произведения. ";
