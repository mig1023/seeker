...
namespace Seeker.Gamebook.MentorsAlwaysRight
{
    class Constants : Prototypes.Constants, Abstract.IConstants
    {
        ...
        public override string GetDescription() => "Молодые парни молча стоят одной ше" +
            "ренгой. Позади восемь лет обучения, изматывающих тренировок и непрерывной" +
            " зубрежки. Восемь лет ночных кошмаров, следствие накачки магическими элик" +
            "сирами. Восемь лет жуткой ломоты во всем теле после каждого тренинга по л" +
            "икантропии.\n\nОбучение начинало два десятка мальчишек и лишь четырнадцат" +
            "ь выживших, сегодня пройдут церемонию посвящения. Они получат право назыв" +
            "аться ведьмаками. ";
