    ...
    class Paragraphs : Interfaces.IParagraphs
    {
        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            ...
            [174] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 288, Text = "Если сумма выпавших чисел больше вашей ЛОВКОСТИ" },
                    new Option { Destination = 430, Text = "Если меньше или равна" },
                }
            },
            [175] = new Paragraph
            {
            ...
            [271] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 489, Text = "Потратить 7 экю на то, чтобы полностью переодеться" },
            ...
            [359] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 29, Text = "Если она больше вашей ЛОВКОСТИ" },
                    new Option { Destination = 446, Text = "Если же меньше или равна" },
                }
            },
            [360] = new Paragraph
            {
            ...
            [590] = new Paragraph
            {
                Options = new List<Option>
                {
                    new Option { Destination = 315, Text = "Если вы знаете это" },
                    new Option { Destination = 656, Text = "Если нет" },
                }
            },
            [591] = new Paragraph
            {
            ...
            [660] = new Paragraph
            {
                Actions = new List<Actions>
                {
                    ...
                    {
                        ActionName = "Get",
                        ButtonName = "Обучится тайному удару",
                    ...
                    {
                        ActionName = "Get",
                        ButtonName = "Обучится бою со шпагой и кинжалом",
                    ...
                    {
                        ActionName = "Get",
                        ButtonName = "Обучится стрельбе с двух рук",
                    ...
                    {
                        ActionName = "Get",
                        ButtonName = "Обучится фехтованию левой рукой",
