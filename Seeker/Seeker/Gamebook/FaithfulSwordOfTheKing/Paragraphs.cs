        ...
        private static Dictionary<int, Paragraph> Paragraph = new Dictionary<int, Paragraph>
        {
            ...
            [566] = new Paragraph
            {
                ...
                Options = new List<Option>
                {
                    ...
                    new Option { Destination = 264, Text = "Если же выпали одинаковые числа" },
                }
            },
            [567] = new Paragraph
            {
            ...
            [660] = new Paragraph
            {
                Actions = new List<Actions>
                {
                    ...
                    new Actions
                    {
                        ...
                        Aftertext = "Овладев этим искусством, вы сможете во время поединка взять в левую руку кинжал и наносить им удары по не владеющему подобным умением противнику. Конечно, для честной дуэли это не слишком-то подходит, но в бою может не раз сохранить вам жизнь. Каждый раз, когда у вас на кубике выпадет четное число, считайте, что вы сумели воспользоваться кинжалом. В этом случае, если раунд атаки вы выиграли, вычтите у противника не 2, а 3 СИЛЫ; если же проиграли, то вычитаете 2 СИЛЫ не только у себя, но и у противника.",
                    },
                    new Actions
                    {
                        ActionName = "Get",
                        ...
                        Aftertext = "Выстрелить из пистолета в XVI веке было делом непростым. Тем более, одновременно прицельно выстрелить из двух пистолетов. Однако вы можете научиться и этому искусству. При этом сможете направить оружие как на разных врагов, так и на одного. В последнем случае, конечно, убить одного человека два раза невозможно, но если один из пистолетов промахнётся, то у вас будет ещё один шанс. Обратите внимание: в том случае, если вы не владеете этим искусством, но у вас есть два пистолета, то будет возможность выстрелить из них только по очереди. Причем вряд ли такой случай представится, ведь после первого же выстрела придется скрестить шпаги со своими врагами, и времени поменять пистолет уже не будет.",
                    },
                    new Actions
                    {
                        ActionName = "Get",
