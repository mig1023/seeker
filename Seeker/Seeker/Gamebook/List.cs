    ...
    class List
    {
        private static Dictionary<string, Description> Books = new Dictionary<string, Description>
        {
            ...
            ["Рандеву"] = new Description
            {
                ...
                SmallDisclaimer = "Ал Торо, 2020; перевод Марии Ерошкиной",
                BookColor = "#ffffff",
                FontColor = "#000000",
                BorderColor = "#000000",
            ...
            ["Месть Альтея"] = new Description
            {
                ...
                SmallDisclaimer = "Джон Баттерфилд и др, 1985; [..подробнее..]",
                FullDisclaimer = "Авторы: Джон Баттерфилд, Дэвид Хонигман и Филип Паркер\n\nПереводчики: Kadena, GalinaSol, Xpromt, Johny Lee, fermalion, Тара-сан, Jumangee, Ajenta, Эргистал, Anuta и другие",
                BookColor = "#ebd5b3",
                FontColor = "#000000",
            ...
            ["Вой оборотня"] = new Description
            {
                ...
                SmallDisclaimer = "Джонатан Грин, 2007; перевод Rustem, Vo1t",
                BookColor = "#383e3b",
            ...
            ["Сердце льда"] = new Description
            {
                ...
                SmallDisclaimer = "Дэйв Моррис, 1994; перевод Kadena и др.",
                BookColor = "#418988",
