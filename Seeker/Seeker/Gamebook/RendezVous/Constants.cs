...
namespace Seeker.Gamebook.RendezVous
{
    class Constants : Prototypes.Constants, Abstract.IConstants
    {
        ...
        public override string GetDescription() => "Уважаемые игроки, это приключение " +
            "не похоже на большинство книг-игр, прочитанных вами ранее. Считайте его п" +
            "росто фантастической историей, в которую можно погрузиться и пережить от " +
            "первого лица.";
