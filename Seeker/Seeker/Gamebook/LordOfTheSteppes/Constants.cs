...
namespace Seeker.Gamebook.LordOfTheSteppes
{
    class Constants : Prototypes.Constants, Abstract.IConstants
    {
        ...
        public override string GetDescription() => "Беда надвигается на Полесье - земл" +
            "и русичей. Все чаще с юга приходят вести о налётах на мирные деревни банд" +
            " степняков, оставляющих после себя сожжённые дома и разлученные семьи. И " +
            "это не обычные лихие разбойники или жаждущие наживы бандиты, а регулярные" +
            " отряды степняков. Что случилось в южном государстве, торговые отношения " +
            "с которым ещё недавно приносили только прибыль? Что делать разрозненным г" +
            "ородам русичей в случае войны, которая кажется неминуемой?\n\nПеред вами " +
            "книга-игра - книга, в которой читатель сам принимает участие в происходящ" +
            "их событиях и решает, как будет развиваться сюжет. И сюжет этот может при" +
            "вести не только к счастливому концу - все зависит от самого читателя, кот" +
            "орый станет героем сказочного мира, где мужественному, но разрозненному н" +
            "ароду русичей угрожает нашествие воинственных степняков. А чтобы в конце " +
            "все жили долго и счастливо, придется воспользоваться смекалкой и запастис" +
            "ь терпением. А ещё вам понадобятся два игральных кубика, листок бумаги, к" +
            "арандаш и ластик.";
